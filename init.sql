DROP SCHEMA IF EXISTS ds_default;
DROP SCHEMA IF EXISTS ds_default_slave_0;
DROP SCHEMA IF EXISTS ds_default_slave_1;
...
CREATE SCHEMA IF NOT EXISTS ds_default;
CREATE SCHEMA IF NOT EXISTS ds_default_slave_0;
CREATE SCHEMA IF NOT EXISTS ds_default_slave_1;
